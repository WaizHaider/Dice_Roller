...
class NewGame : AppCompatActivity(), SensorEventListener {
    ...
    lateinit var dice: RelativeLayout
        ...
        rollBtn.setOnClickListener {
            ...
            if(counter1 == 1 ){
                if(sum1 < tarValue || sum2 < tarValue){
                    rollDice()
                    comRollDice()
                    Toast.makeText(this@NewGame, "You Have 2 optional Dice Roll left", Toast.LENGTH_SHORT).show()
                    counter1 += 1
                }else{
                    ...
                    Toast.makeText(this@NewGame, "End Game", Toast.LENGTH_SHORT).show()
                ...
                if(sum1 < tarValue || sum2 < tarValue){
                    rollDice()
                    comRollDice()
                    Toast.makeText(this@NewGame, "You're near to your limit", Toast.LENGTH_SHORT).show()
                    counter1 += 1
                }else{
                    intent = Intent(this, WinActivity::class.java)
                    intent.putExtra("sum",sum1)
                ...
                if(sum1 < tarValue || sum2 < tarValue){
                    rollDice()
                    comRollDice()
                    Toast.makeText(this@NewGame, "You're Done", Toast.LENGTH_SHORT).show()
                    counter1 += 1
                    intent = Intent(this, WinActivity::class.java)
                    intent.putExtra("sum",sum1)
                    intent.putExtra("sum1",sum2)
    ...
    override fun onBackPressed() {
        ...
        Toast.makeText(this@NewGame, "You Need To Finish This Game", Toast.LENGTH_SHORT).show()
    }
